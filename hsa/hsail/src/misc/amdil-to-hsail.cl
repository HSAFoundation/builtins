...
extern __attribute__((const)) int  __hsail_mulhi_s64(int, int);
extern __attribute__((const)) uint __hsail_mulhi_u64(uint, uint);
...
extern __attribute__((const)) float __cvt_f32_f16(uint op1);

extern __attribute__((const)) float __cvt_f16_rtz_f32(float op1);
extern __attribute__((const)) float __cvt_f16_rte_f32(float op1);
extern __attribute__((const)) float __cvt_f16_rtn_f32(float op1);
extern __attribute__((const)) float __cvt_f16_rtp_f32(float op1);

extern __attribute__((const)) float __cvt_f16_rtz_f64(double op1);
extern __attribute__((const)) float __cvt_f16_rte_f64(double op1);
extern __attribute__((const)) float __cvt_f16_rtn_f64(double op1);
extern __attribute__((const)) float __cvt_f16_rtp_f64(double op1);
