...
extern __attribute__((pure)) float __amdil_frexp_mant_f32(float);
extern __attribute__((pure)) int __amdil_frexp_exp_f32(float);
extern __attribute__((pure)) float __amdil_ldexp_f32(float, int);
